...
export default function ChatMessage({ message, isLastAssistant, onRegenerate, isLoading }: ChatMessageProps) {
            ...
            {!isUser && message.content && (
              <>
                <div className="relative group/copy">
                  ...
                  <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 text-xs text-white bg-gray-800 dark:bg-gray-700 rounded opacity-0 group-hover/copy:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                    {copied ? "Copied!" : "Copy"}
                  </span>
                </div>
                {isLastAssistant && onRegenerate && (
                  <div className="relative group/regen">
                    <button
                      ...
                      disabled={isLoading}
                      className="cursor-pointer text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    ...
                    <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 text-xs text-white bg-gray-800 dark:bg-gray-700 rounded opacity-0 group-hover/regen:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                      Regenerate
                    </span>
                  </div>
                )}
